...
<body class="home5-page">
    ...
    <div class="left-sidebar">
        ...
        <img class="me" src="assets/images/profile2-1.jpg" alt="Me" />
        <h2 class="email">anambrur@gmail.com</h2>
        <h2 class="address">Dhanmondi Riverview Model Town</h2>
        <p class="copyright">&copy; 2024 ANAM. All Rights Reserved</p>
                        ...
                        <div class="hero-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom">
                                    Hello, I’m <span>MH ANAM</span>, Full Stack Web Developer
                                </h1>
                            </div>
                ...
                <section class="about-area page-section scroll-to-page" id="about">
                    <div class="custom-container">
                        <div class="about-content content-width">
                            ...
                            <p class="scroll-animation" data-animation="fade_from_bottom">
                                With a proven track record in web development, I bring a versatile skill set
                                encompassing both front-end and back-end technologies. My expertise spans HTML, CSS,
                                JavaScript, MySQL, WordPress, Laravel, React.js, Vue.js and more. I excel in crafting
                                visually stunning and highly functional websites and web applications, meeting clients'
                                diverse needs and exceeding expectations
                            </p>
                            <hr>
                            <h6 class="pb-2">Birthday &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                23 Aug 1998</h6>
                            <h6 class="pb-2">Phone
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                +880 1714613653</h6>
                            <h6 class="pb-2">Email
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                anambrur@gmail.com</h6>
                            <h6 class="pb-2">From
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                Dhanmondi-15,Dhaka-1209</h6>
                            <h6 class="pb-2">Language &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Bangla, English
                            </h6>
                            <h6 class="pb-2">Full Time Job &nbsp;: Available</h6>
                            <h6 class="pb-2">Freelance &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Available</h6>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="resume-content content-width">
                            ...
                            <div class="resume-timeline">
                                <div class="item scroll-animation" data-animation="fade_from_right">
                                    ...
                                    <h2>Web Application Development with Laravel, React, Vue.js & WordPress</h2>
                                    <p>IsDB-BISEW</p>
                                </div>
                                <div class="item scroll-animation" data-animation="fade_from_right">
                                    <span class="date">2017 - 2022</span>
                                    <h2>MSS (Master) in Public Administration</h2>
                                    <h6 class="pt-1">CGPA 3.24</h6>
                                    <p>Begum Rokeya University, Rangpur </p>
                                    <h2>BSS (Hons) in Public Administration</h2>
                                    <h6 class="pt-1">CGPA 3.35</h6>
                                    <p>Begum Rokeya University, Rangpur </p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="services-items">
                                        <div class="service-item scroll-animation mb-4"
                                            data-animation="fade_from_bottom">
                                            <i class="las la-project-diagram"></i>
                                            <h2>ERD Design</h2>
                                            <p>
                                                I have knowledge in designing Entity-Relationship (ER) diagrams for
                                                databases.
                                            </p>
                                        ...
                                        <div class="service-item scroll-animation mb-4"
                                            ...
                                            <p>
                                                I have knowledge in React. I have the ability to provide good,
                                        ...
                                        <div class="service-item scroll-animation mb-4"
                                            ...
                                            <h2>RESTful API</h2>
                                            <p>
                                                I have knowlege in creating RESTful api for web applications. Have
                                ...
                                <div class="col-md-6">
                                    <div class="services-items">
                                        <div class="service-item scroll-animation mb-4"
                                            ...
                                            <p>
                                                Have knowledgae in Php and Laravel, have ability to provide good web
                                                application backend.
                                            </p>
                                        ...
                                        <div class="service-item scroll-animation mb-4"
                                            ...
                                            <h2>Debugging</h2>
                                            <p>
                                                Debugging is one of the most important skills that I have. Will provide
                                                you good debuggin service
                                            </p>
                                        ...
                                        <div class="service-item scroll-animation mb-4"
                                            ...
                                            <h2>WebSocket</h2>
                                            <p>
                                                Have ability to provide live chat service. Have knowledge in laravel
                        ...
                        <div class="skills-content content-width">
                            ...
                            <div class="row skills text-center">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/Javascript.png" alt="Figma" />
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/html.png" alt="Webflow" />
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/bootstrap.png" alt="Webflow" />
                                            <h1 class="percent">95%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/vue.png" alt="Webflow" />
                                            <h1 class="percent">95%</h1>
                                        </div>
                            ...
                            <div class="row portfolio-items">
                                <div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="portfolio-item portfolio-full">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/pos.png" data-lightbox="example-1">
                                                <img src="assets/images/pos.png" alt="Portfolio" />
                                            </a>
                                        ...
                                        <h2>
                                            <a href="https://demopos.mhanam.com/">Point of Sales System --(POS)</a>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_left">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/fruits.png" data-lightbox="example-1">
                                                <img src="assets/images/fruits.png" alt="Portfolio" />
                                            </a>
                                        ...
                                        <h2><a href="https://fruits.mhanam.com">Fruitables -- Dynamic Website (CMS)</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/fruitsAdmin.png" data-lightbox="example-1">
                                                <img src="assets/images/fruitsAdmin.png" alt="Portfolio" />
                                            </a>
                                        ...
                                        <h2><a href="https://adminfruits.mhanam.com">Fruitables Admin Panel</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/production.png" data-lightbox="example-1">
                                                <img src="assets/images/production.png" alt="Portfolio" />
                                            </a>
                                        ...
                                        <h2>
                                            <a href="https://prantiksoft.com/production">Production Automation Systems</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="assets/images/client1.png" alt="testinomial" />
                                                <div class="right">
                                                    <h3>Moshaidul Islam</h3>
                                                    <p class="designation">
                                                        Consultant of <span>IsDB BISEW</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <p>
                                                Anam - A Developer with the creativity, professional
                                                and master of code. Much more than what i'm expect.
                                                High quality product & flexiable price. Recommended!.”
                                            </p>

                                            <a href="#portfolio" class="project-btn">Project</a>
                                        </div>
                                    </div>
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="assets/images/client2 (1).png" alt="testinomial" />
                                                <div class="right">
                                                    <h3>Farhana Lucky</h3>
                                                    <p class="designation">
                                                        Instructor
                                            ...
                                            <p>
                                                Anam was a real pleasure to work with and we look
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                ...
                                                <div class="right">
                                                    <h3>Morshed Habib Sohel</h3>
                                                    <p class="designation">
                                                        Instructor <span>BITL</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <p>
                                                “Extremely profressional and fast service!. Anam is a
                                    ...
                                    <div class="col-md-6 scroll-animation" data-animation="fade_from_left">
                                        <div class="pricing-table">
                                            ...
                                            <ul class="feature-lists">
                                                ...
                                                <li>
                                                    Implement with Webflow, React, WordPress,
                                                    Laravel/PHP
                                                </li>
                                                <li>Remote/Online</li>
                    ...
                    <div class="custom-container">
                        <div class="contact-content content-width">
                            ...
                            <form class="contact-form scroll-animation" data-animation="fade_from_bottom"
                                method="POST" action="https://wpriverthemes.com/HTML/drake/mailer.php">
                                        ...
                                        <div class="input-group upload-attachment">
                                            <div>
                                                <label for="upload-attachment">
                                                    <i class="las la-cloud-upload-alt"></i> add an
                                                    attachment
...
<!-- Mirrored from wpriverthemes.com/HTML/drake/home5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 14:22:25 GMT -->
